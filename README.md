...
![Схема](docs/scheme.jpg)

### Screenshots rqt_graph
*До підключення esp32*  ![Граф](docs/step_7.png)
*Після підключення esp32* ![Граф](docs/graph_with_esp32.png)
...
### Етап 7
При зупинці 3 підписника він повністю зникає з графа разом зі стрілкою, що значить що повідомлення йому не йде. ![Граф](docs/step_7.1.png)
При зупинці видавця він зникає і зникає стрілка, яка сполучала його і топік проте залишається сам топік і підписники, просто не отримують повідомлення. ![Граф](docs/step_7.2.png)
...
![Фото схеми і serial monitor](docs/photo.jpeg)
